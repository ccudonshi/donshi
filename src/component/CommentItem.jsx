...
import { Text, StyleSheet, View, Image, Alert, TouchableHighlight, TouchableOpacity } from 'react-native'
                ...
                <View style={styles.nameTextProPicContainer}>
                    ...
                    <View style={styles.nameTextContainer}>
                        <View>
                            ...
                            {/* <Text numberOfLines={30} style={{ marginTop: 5 }}>{unicodeToChar(this.props.comment.text)}</Text> */}
                        </View>
                    </View>
                </View>
